...
const MAGAZINES = [
  {
    ...
    issue: 'Issue #46',
    label: 'Issue #46: Sport & Soul',
    desc: 'The psychology of elite competition.',
    coverBg: 'bg-blue-900',
    img: `${process.env.PUBLIC_URL}/cover_1_peak_performance.jpg`,
    imgClass: 'w-full h-full object-cover mix-blend-overlay',
    CoverContent: () => (
      <div className="absolute inset-0 flex flex-col justify-end p-6 text-white bg-gradient-to-t from-blue-900 via-transparent to-transparent">
        <h3 style={{ fontFamily: 'Oswald, sans-serif' }} className="text-5xl uppercase leading-none">The<br/>Arena</h3>
        <p className="text-xs mt-2 tracking-[0.2em] font-bold">ATHLETES OF THE DECADE</p>
      </div>
    ),
    article: {
      title: 'The Mind Is the Muscle',
      subtitle: 'How elite athletes are unlocking performance through sports psychology',
      author: 'Chidi Okonkwo',
      role: 'Sports Correspondent',
      readTime: '7 min read',
      pullQuote: 'The gap between a good athlete and a great one is rarely physical. It lives entirely in the space between the ears.',
      body: [
        'What separates a world champion from a competitor who finishes fourth? According to decades of sports science research, it is rarely a matter of physical conditioning alone. The margin at elite level is so thin that psychology — the ability to perform under crushing pressure, to recover from failure, to maintain focus when everything is on the line — has become the final frontier of athletic excellence.',
        'Sports psychologist Dr. Ama Sarpong, who has worked with several African national teams, describes the shift she has witnessed: "Ten years ago, athletes came to me only when something was wrong. Now they come to build mental strength the same way they build physical strength. The stigma is disappearing." The change is most visible in team sports, where coaches increasingly build mental skills training into weekly schedules alongside gym sessions and tactical drills.',
        'The concept of flow state — what athletes describe as being "in the zone" — has been studied rigorously since the 1970s, but only recently have practitioners found reliable ways to help athletes access it intentionally. Techniques such as pre-performance routines, box breathing, cognitive restructuring and visualisation have moved from sports psychology research labs into mainstream coaching.',
        'Elite distance runners from Kenya and Ethiopia have long understood the role of mental toughness, even without formalising it. Faith Kipyegon, the Kenyan who became the only three-time Olympic champion in the 1500m at the Paris 2024 Games, has spoken candidly about how she visualises her races in precise detail before every major competition. Every stride, every position change, every surge — she has already run the race in her mind dozens of times before lacing her spikes.',
        'The science backs this up. Studies show that mental rehearsal activates many of the same neural pathways as physical practice, effectively giving athletes additional training repetitions without the physical cost. For athletes competing in short explosive events — sprinters, boxers, weightlifters — this edge can be the difference between gold and nothing at all.',
        'Letsile Tebogo of Botswana embodied this at Paris 2024, winning his country\'s first-ever Olympic gold in the men\'s 200m at just 21 years old. In post-race interviews, he described a mental approach of complete present-moment focus, not thinking about rivals or medals, just the next stride. That kind of discipline, coaches say, cannot be improvised on race day. It must be practised.',
        'As African sport continues its ascent on the world stage, the integration of mental performance coaching into athlete development programmes across the continent is no longer optional — it is essential. The era of raw talent winning alone is over. The champion\'s edge is psychological.',
      ],
    },
  },
  {
  ...
  },
  {
    ...
    issue: 'Issue #42',
    label: 'Issue #42: Market Trends',
    desc: 'Exploring the future of decentralized finance.',
    coverBg: 'bg-slate-800',
    img: `${process.env.PUBLIC_URL}/cover_3_global_economic.jpg`,
    imgClass: 'w-full h-full object-cover opacity-60',
    CoverContent: () => (
      <div className="absolute bottom-0 left-0 p-6 text-white bg-gradient-to-t from-black/80 to-transparent w-full">
        <span className="text-xs font-bold uppercase tracking-tighter opacity-80">Winter 2024</span>
        <h3 className="text-xl font-bold">The Global Shift</h3>
      </div>
    ),
    article: {
      title: 'The World Economy Is Being Redrawn',
      subtitle: 'Trade wars, AI disruption and a shifting power balance are creating a new global order',
      author: 'Taiwo Bankole',
      role: 'Economics Correspondent',
      readTime: '9 min read',
      pullQuote: 'The old assumptions of global trade — that Western economies set the rules, that the dollar dominates, that growth flows from North to South — are being systematically dismantled.',
      body: [
        'The economic map of the world is being redrawn at a pace few analysts anticipated. A confluence of forces — geopolitical realignment, the rise of AI as a productive technology, shifting trade blocs and the emergence of new economic powers — is creating conditions of both profound opportunity and significant risk for businesses and governments across the globe.',
        'Africa is emerging from this turbulence in a position of unexpected strength. The African Development Bank projected the continent\'s economy to grow from 3.3 percent in 2024 to 3.9 percent in 2025, with projections of 4 percent in 2026. More significantly, Africa is set to account for eleven of the world\'s twenty fastest-growing economies in 2024, outpacing global averages for the second consecutive period. East Africa leads this momentum, with growth projections of 5.9 percent for 2025-2026 driven by Ethiopia, Rwanda and Tanzania.',
        'The African Continental Free Trade Area (AfCFTA) represents perhaps the most ambitious economic integration project in the world. Full implementation could increase African exports by $560 billion and boost continental income by $450 billion by 2035, according to the African Development Bank. These are not aspirational numbers — they reflect the continent\'s 30 percent share of global mineral reserves and a demographic dividend that gives Africa a median age of just 19, creating a workforce that could add $47 billion to GDP through improved participation.',
        'Yet the challenges are formidable. Nearly half of African nations carried debt-to-GDP ratios above 60 percent in 2023, with many governments spending more on debt servicing than on education or health. Infrastructure gaps in transport, energy and digital connectivity push trade costs 50 percent above the global average. Less than half of Africans have reliable electricity access, and closing the energy gap would require $190 billion annually.',
        'The broader global picture is equally complicated. Geopolitical fragmentation — manifested in tariff walls, supply chain reshoring and the weaponisation of trade policy — threatens the open global system that enabled decades of emerging market growth. Africa, as the most trade-exposed region, faces disproportionate vulnerability to these shifts, even as its internal markets grow.',
        'The businesses that will thrive in this environment are those that read these macro forces early, diversify their exposure across multiple markets, and invest in the digital infrastructure that is increasingly the prerequisite for participation in global commerce. The economic shift is not a crisis to survive — it is a reordering to navigate with intelligence and speed.',
      ],
    },
  },
  {
    ...
    sortOrder: 12,
    category: 'tech',
    title: 'AI & The Creative Mind',
    issue: 'Issue #43',
    label: 'Issue #43: Tech Frontier',
    desc: 'How generative models change art.',
    coverBg: 'bg-orange-600',
    img: `${process.env.PUBLIC_URL}/cover_4_ai_creative.jpg`,
    imgClass: 'w-full h-full object-cover mix-blend-multiply opacity-80',
    CoverContent: () => (
      <div className="absolute inset-0 flex items-center justify-center p-8 text-center text-white">
        <h3 style={{ fontFamily: 'Playfair Display, serif' }} className="text-3xl italic">AI & THE MIND</h3>
      </div>
    ),
    article: {
      title: 'The Machine That Learned to Dream',
      subtitle: 'Generative AI is reshaping creativity across music, film, design and literature — and Africa is in the conversation',
      author: 'Kelechi Eze',
      role: 'Technology Editor',
      readTime: '8 min read',
      pullQuote: 'AI does not replace the creative mind. It reveals what the creative mind is actually made of — judgment, taste, intention, and the irreplaceable act of choosing what matters.',
      body: [
        'In a small studio in Lekki, Lagos, a music producer is finishing a track. He has used an AI tool to generate a foundation of rhythm and harmony, but every decision about texture, feel, cultural reference and emotional arc was his. The result sounds nothing like a machine made it. It sounds like Lagos — layered, alive, insistently human.',
        'This is the real story of generative AI and creativity, and it is considerably more interesting than the headlines about robots replacing artists. The technology is real, its capabilities are expanding rapidly, and it is genuinely disrupting creative industries. But the disruption is not the erasure of human creativity. It is a radical acceleration of what humans can produce, and a profound shift in where creative value lies.',
        'Large language models and image generation tools have moved from curiosity to professional instrument at extraordinary speed. Advertising agencies, film studios, game developers, and fashion houses are integrating AI into production workflows across every stage — concept development, iteration, post-production and distribution. The efficiency gains are significant. A design process that once took weeks now takes days. A visual concept that required a full team can be explored by a single creative with the right tools.',
        'For African creatives, the implications are particularly interesting. The continent has long been constrained by access to expensive production infrastructure — the studios, equipment and specialist labour that wealthy markets take for granted. AI tools democratise access to capability in a way that no previous technology has matched. A filmmaker in Nairobi can now achieve visual effects quality that would have cost a Hollywood budget a decade ago. A writer in Accra can use AI as a research and drafting partner that previously required an entire editorial team.',
        'The concern, voiced by artists across every discipline, is about homogenisation — that AI trained primarily on Western data will subtly flatten cultural specificity, nudging creative outputs toward a globalised aesthetic that erases distinctiveness. This is a legitimate risk, and one that requires conscious resistance. The antidote is not less AI but more intentionality about what gets fed into the process and what decisions remain irreducibly human.',
        'The African creative economy — already generating enormous global cultural value through music, film, fashion and design — is well positioned to lead the next wave of AI-augmented creativity, provided practitioners engage with the technology on their own terms, not as passive consumers of tools built elsewhere for audiences elsewhere. The machine can dream. But it still needs someone to tell it what to dream about.',
      ],
    },
  },
  {
    ...
    issue: 'Issue #44',
    label: 'Issue #44: Lifestyle',
    desc: '20 ways to reduce your footprint.',
    coverBg: 'bg-green-900',
    img: `${process.env.PUBLIC_URL}/cover_5_sustainable.jpg`,
    imgClass: 'w-full h-full object-cover opacity-70',
    CoverContent: () => (
      <div className="absolute bottom-0 left-0 p-6 text-white bg-gradient-to-t from-black/80 to-transparent w-full">
        <span className="text-xs font-bold uppercase tracking-tighter opacity-80">New Release</span>
        <h3 className="text-xl font-bold">Earth First</h3>
      </div>
    ),
    article: {
      title: 'Living Lightly on a Heavy Continent',
      subtitle: 'African innovators are showing the world that sustainability and prosperity are not opposing forces',
      author: 'Amara Diallo',
      role: 'Lifestyle Correspondent',
      readTime: '6 min read',
      pullQuote: 'The continent that contributed least to the climate crisis is developing the most creative responses to it. That is not irony — it is innovation born from necessity.',
      body: [
        'The conversation about sustainable living is changing in Africa, and not in the direction most outsiders expect. While Western discourse often frames sustainability as a sacrifice — consuming less, flying less, owning less — in many parts of Africa, the sustainability movement is about building more: more reliable energy, more efficient systems, more resilient food production, more durable infrastructure that does not need constant replacement.',
        'Climate hazards affected over 110 million Africans in 2022 and caused an estimated $8.5 billion in damages. Agriculture, which remains a primary source of income for hundreds of millions, is acutely vulnerable to the pattern shifts that climate change is driving. The stakes of sustainable innovation here are not abstract — they are existential.',
        'Yet the response across the continent has been remarkable. Solar adoption in sub-Saharan Africa has accelerated dramatically as panel costs have fallen, with off-grid solar now providing electricity to millions of households that the central grid cannot reach. In Kenya, geothermal energy accounts for a significant portion of national power generation, making it one of the cleanest electricity grids on the continent. Rwanda has implemented some of the world\'s strictest bans on single-use plastic, and its capital Kigali is routinely cited as one of the cleanest cities in Africa.',
        'Urban sustainability is taking a distinctly African form. In cities like Lagos, Nairobi and Accra, informal recycling networks — often dismissed by planners — process enormous volumes of waste with minimal infrastructure. Young entrepreneurs are formalising these networks, adding technology layers, and turning them into scalable businesses. The circular economy, a concept being theorised in European business schools, has been practised in African markets for generations.',
        'For individuals, the shift toward sustainable living in an African context often means thoughtful consumption — buying quality goods that last rather than cheap goods that need constant replacement, supporting local food producers, investing in solar where possible and building habits that separate status from material accumulation.',
        'The insight emerging from African sustainability thinkers is one that resonates globally: the question is not how to live with less, but how to live with intention. Prosperity and sustainability, understood correctly, point in the same direction.',
      ],
    },
  },
  {
    ...
    issue: 'Issue #48',
    label: 'Issue #48: Champion Spirit',
    desc: 'Why the world loves an underdog.',
    coverBg: 'bg-emerald-900',
    img: `${process.env.PUBLIC_URL}/cover_6_underdog.jpg`,
    imgClass: 'w-full h-full object-cover grayscale contrast-125 opacity-40',
    CoverContent: () => (
      <div className="absolute top-10 left-10 text-white border-l-4 border-emerald-400 pl-4">
        <h3 style={{ fontFamily: 'Oswald, sans-serif' }} className="text-4xl">VICTORY</h3>
      </div>
    ),
    article: {
      title: 'Against Every Odd',
      subtitle: "Letsile Tebogo's 200m gold at Paris 2024 is the underdog story of a generation — and it began in a dusty Botswana town",
      author: 'Samuel Asante',
      role: 'Sports Features Writer',
      readTime: '7 min read',
      pullQuote: "He was not supposed to win. The bookmakers had him as an outside bet. His country had never won an Olympic gold medal. He was 21 years old. None of that mattered when the gun fired.",
      body: [
        'There is something about the underdog story that transcends sport. We don\'t just watch them win — we need them to win. They carry something for us: the belief that conditions are not destiny, that the gap can be closed by will and work and a refusal to accept the script that others have written.',
        'Letsile Tebogo wrote one of the great underdog stories of modern sport when he won Botswana\'s first ever Olympic gold medal in the men\'s 200 metres at Paris 2024. He was 21 years old. He beat Kenneth Bednarek. He beat Noah Lyles, the defending world champion who had seemed unbeatable in the lead-up to the Games. He ran 19.46 seconds — an African record — and he did it with a composure that seemed to belong to someone twice his age.',
        'Tebogo grew up in Letlhakane, a small mining town in central Botswana, where a sprint track was not an obvious fixture of the landscape. He discovered his speed almost by accident, representing Botswana at the World Under-20 Championships, where he won silver in the 100m in 2022. The world began to notice, but Botswana itself — a country better known for diamonds and safaris than sprint medals — had not yet fully grasped what was developing in its midst.',
        'By 2023, it was harder to ignore. Tebogo won silver in the 200m at the World Championships in Budapest, establishing himself as a genuine contender. But the question remained: could he deliver when it mattered most, on the biggest stage in sport, under the full weight of Olympic expectation?',
        'He could. In Paris, he did not just win. He ran with authority and joy, the sprinter\'s ideal fusion of power and freedom. His post-race celebration — arms wide, face lit — became one of the defining images of the Games.',
        'The story resonates beyond athletics. Botswana has a population of roughly 2.6 million people. It has one Olympic gold medallist. That one person carried an entire nation\'s sporting history on his spikes and made something impossible feel inevitable. That is what the underdog story does, when it is real and not manufactured: it expands what people believe is possible for themselves.',
      ],
    },
  },
  ...
  // ── Business ──────────────────────────────────────────────
  {
    ...
    title: 'Africa Rising',
    issue: 'Issue #49',
    label: 'Issue #49: Africa Rising',
    desc: 'The continent rewriting the rules of global trade.',
    coverBg: 'bg-amber-900',
    img: `${process.env.PUBLIC_URL}/cover_7_africa_rising.jpg`,
    imgClass: 'w-full h-full object-cover mix-blend-overlay opacity-70',
    CoverContent: () => (
      <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
    ),
    article: {
      title: 'The Continent That Cannot Be Ignored',
      subtitle: 'With eleven of the world\'s twenty fastest-growing economies, Africa is no longer rising — it has risen',
      author: 'Dr. Adaeze Okonkwo',
      role: 'Chief Economics Writer',
      readTime: '10 min read',
      pullQuote: 'Africa hosts 30 percent of global mineral reserves, a workforce growing faster than any other region, and a consumer class expanding by tens of millions each year. This is not a future story. This is happening now.',
      body: [
        'For much of the twentieth century, Africa\'s economic story was told by others, and it was rarely flattering. The dominant narrative combined the language of aid dependency, governance failure and untapped potential — a continent perpetually on the verge of a breakthrough that never quite arrived. That narrative is now dangerously out of date.',
        'Africa is projected to account for eleven of the world\'s twenty fastest-growing economies in 2024. Overall GDP growth for the continent is expected to average 3.8 percent in 2024 and 4.2 percent in 2025, outpacing global averages. East Africa leads this momentum with projected growth of 5.9 percent in 2025-2026. Countries like Ethiopia, Rwanda and Senegal are growing at rates that approach the 7 percent threshold economists associate with genuine structural transformation.',
        'The raw numbers tell part of the story. South Africa\'s GDP stands at over $373 billion, the continent\'s largest. But the more telling figures are in the trend lines: 21 African countries are expected to achieve growth exceeding 5 percent in 2025. The African Development Bank estimates the continent could mobilise an additional $1.43 trillion in domestic resources through efficiency gains alone — without a single new discovery or external investment.',
        'The African Continental Free Trade Area is the institutional framework that could translate this growth into lasting transformation. Full implementation is projected to increase intra-African exports by $560 billion and boost continental income by $450 billion by 2035. Currently, intra-African trade accounts for only 16 percent of the continent\'s total trade — a figure that makes no sense given the scale of the economies involved. The Pan-African Payment and Settlement System, launched under the AfCFTA framework, is beginning to enable traders to settle transactions in local currencies, reducing dependence on the US dollar and cutting transaction costs.',
        'The challenge is that the continent\'s extraordinary mineral wealth — 30 percent of global reserves, including the critical green minerals that will power the clean energy transition — has historically generated wealth that flowed outward rather than inward. Breaking this pattern, building value-added industries rather than exporting raw commodities, is the economic task of this generation of African leadership.',
        'For businesses and investors, the opportunity is real and urgent. The demographic dividend — a median age of 19, a formal workforce growing faster than any other region — creates consumer markets, labour pools and innovation ecosystems that no serious global operator can afford to ignore. Africa is not rising. It has risen. The only remaining question is who will be in position to grow with it.',
      ],
    },
  },
  {
  ...
  // ── Technology ────────────────────────────────────────────
  {
    ...
    sortOrder: 17,
    category: 'tech',
    title: 'Fintech & The Unbanked',
    issue: 'Issue #51',
    label: 'Issue #51: Fintech Revolution',
    desc: 'How mobile money is rewriting financial access.',
    coverBg: 'bg-cyan-900',
    img: `${process.env.PUBLIC_URL}/cover_9_fintech.jpg`,
    imgClass: 'w-full h-full object-cover mix-blend-luminosity opacity-60',
    CoverContent: () => (
      <div className="absolute inset-0 flex flex-col justify-end p-6 text-white bg-gradient-to-t from-cyan-900 via-cyan-900/40 to-transparent">
        <p className="text-[9px] font-black tracking-[0.3em] uppercase text-cyan-300 mb-2">Tech Report</p>
        <h3 style={{ fontFamily: 'Oswald, sans-serif' }} className="text-4xl uppercase leading-tight">Fintech &<br/>The Unbanked</h3>
        <p className="text-xs mt-2 text-cyan-200 font-medium">1.4 billion people. One phone. Infinite potential.</p>
      </div>
    ),
    article: {
      title: 'Money in Your Pocket',
      subtitle: 'How mobile money is banking hundreds of millions of Africans who never set foot inside a traditional bank',
      author: 'Emeka Okafor',
      role: 'Fintech Correspondent',
      readTime: '8 min read',
      pullQuote: 'In Sub-Saharan Africa, a third of all account holders have no other kind of account than mobile money. For them, a phone is not a convenience — it is their entire financial life.',
      body: [
        'The most significant financial inclusion achievement of the twenty-first century did not happen in a bank boardroom or a Silicon Valley startup. It happened on basic feature phones, through a technology called USSD, across the rural and peri-urban landscapes of sub-Saharan Africa. Mobile money has brought hundreds of millions of people into the formal financial system — and it has done so without requiring a smartphone, reliable internet, or proximity to a physical branch.',
        'The numbers are staggering. By 2024, 40 percent of adults in sub-Saharan Africa had a mobile money account, up from 27 percent just three years earlier. That surge contributed to overall financial account ownership in the region growing from 49 percent to 58 percent in the same period. In Kenya, mobile money penetration exceeds 82 percent of the adult population. M-Pesa, launched by Safaricom in 2007, processes over $50 billion in transactions annually — roughly a quarter of Kenya\'s entire GDP — and serves more than 51 million active users across multiple countries.',
        'The impact on economic life is not merely statistical. In Tanzania, mobile money accounts outnumber bank accounts by a ratio of four to one. In Ghana and Uganda, over 70 percent of formal borrowers now access credit through mobile money providers. Women entrepreneurs in rural areas, who have historically faced the highest barriers to financial services, are opening mobile money accounts and accessing working capital for the first time.',
        'Nigeria — Africa\'s most populous country — is developing a particularly dynamic fintech ecosystem. Nigeria\'s instant payments infrastructure processed over $1 trillion in transactions in 2024. Opay and PalmPay have together enrolled tens of millions of users. Nigeria is home to over 250 fintech companies, with 15 percent focused specifically on SME lending. The Central Bank\'s licensing of Payment Service Banks allowed non-bank entities to offer full financial services, accelerating last-mile delivery particularly in rural areas.',
        'The broader African mobile money market was valued at approximately $804 million in 2024, with projections to reach $3.93 billion by 2033 — a compound annual growth rate of over 18 percent. Fintech also attracted more than 40 percent of all startup venture capital on the continent in 2024, signalling that global investors now understand what practitioners have known for years: Africa is the global frontier of financial innovation.',
        'The challenges are real — digital literacy gaps, cybersecurity risks, regulatory fragmentation and the difficulty of serving populations without consistent internet access. But the trajectory is clear. Mobile money is not a workaround for the absence of banking. It is increasingly the primary financial infrastructure of a continent, and it is building wealth at the base of the pyramid in ways no prior financial system ever managed.',
      ],
    },
  },
  {
    ...
    sortOrder: 18,
    category: 'tech',
    title: 'The Data Continent',
    issue: 'Issue #52',
    label: 'Issue #52: Data & Privacy',
    desc: 'Who owns Africa\'s data — and who profits from it.',
    coverBg: 'bg-indigo-950',
    img: `${process.env.PUBLIC_URL}/cover_10_data_continent.jpg`,
    imgClass: 'w-full h-full object-cover mix-blend-color-dodge opacity-40',
    CoverContent: () => (
      <>
        <div className="absolute inset-0 flex items-start justify-end p-6">
          <div className="text-right text-white">
            <p className="text-[9px] tracking-[0.25em] uppercase text-indigo-300 font-bold">Issue #52</p>
          </div>
        </div>
        <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-indigo-950 to-transparent">
          <h3 style={{ fontFamily: 'Playfair Display, serif' }} className="text-white text-3xl italic leading-snug">The Data<br/>Continent</h3>
          <div className="flex gap-1 mt-3">
            {[...Array(5)].map((_,i) => <div key={i} className="h-0.5 flex-1 bg-indigo-400 opacity-60" />)}
          </div>
        </div>
      </>
    ),
    article: {
      ...
      subtitle: 'As Africa generates more data than ever before, a critical battle over who owns it — and who profits — is only just beginning',
      author: 'Priscilla Mensah',
      role: 'Digital Economy Editor',
      readTime: '7 min read',
      pullQuote: 'Every mobile money transaction, every health record, every agricultural sensor reading is a data point. Together, they represent an extraordinary national asset. The question is whether African governments and citizens will own it, or surrender it for free.',
      body: [
        'Data is the defining resource of the twenty-first century economy. This is not a metaphor. The companies that have accumulated the largest concentrations of data — Google, Meta, Amazon, Alibaba — are among the most valuable organisations in human history. Their value derives not from physical assets but from their knowledge of human behaviour, preference and need, extracted from billions of daily interactions.',
        'Africa is generating data at an accelerating rate. Every mobile money transaction, every digital health record, every e-commerce purchase, every WhatsApp message creates information. The continent\'s 709 million mobile money accounts alone produce transaction data that is extraordinarily valuable for credit scoring, fraud detection, consumer insight and policy planning. As smartphone penetration continues rising and African e-commerce is projected to serve over 500 million users by 2025, this data pool is expanding rapidly.',
        'The sovereignty question is stark: who owns this data, and under what conditions is it accessible? Currently, much of the data generated on African platforms flows to servers in Europe or the United States, governed by the data policies of foreign corporations and the laws of foreign jurisdictions. African governments and citizens have limited visibility into how their data is used, shared, or monetised.',
        'Several African countries are moving to address this. Nigeria, South Africa, Kenya and others have enacted or updated data protection legislation modelled partly on the European GDPR framework. South Africa was an early mover in cryptocurrency regulation, and Nigeria\'s Securities and Exchange Commission is progressively building regulatory frameworks for digital assets. These are important steps, but enforcement capacity remains uneven.',
        'The opportunity is to do more than regulate. Countries that build domestic data infrastructure — cloud hosting, data centres, AI training capacity — can keep more of the economic value generated by African data within African economies. Rwanda and South Africa are already pursuing data centre development as part of their digital economy strategies.',
        'For African businesses, the data sovereignty conversation is not abstract. Companies that build their own first-party data relationships with customers — rather than renting audience access from foreign platforms — will have a durable competitive advantage in an era when data privacy regulation is tightening globally. The data continent is worth building. But it requires deciding, now, that it will be built by and for Africans.',
      ],
    },
  },
  ...
  // ── Sport ─────────────────────────────────────────────────
  {
    ...
    sortOrder: 16,
    category: 'sport',
    title: 'Africa at the Olympics',
    issue: 'Issue #53',
    label: 'Issue #53: Olympic Edition',
    desc: 'Gold, glory and the athletes carrying a continent.',
    coverBg: 'bg-yellow-900',
    img: `${process.env.PUBLIC_URL}/cover_11_olympics.jpg`,
    imgClass: 'w-full h-full object-cover mix-blend-overlay',
    CoverContent: () => (
      <div className="absolute inset-0 flex flex-col justify-between p-6 text-white">
        <div className="flex justify-between items-start">
          <span className="text-[9px] font-black tracking-[0.2em] uppercase text-yellow-300">Olympic Special</span>
          <div className="flex gap-0.5">
            {['bg-yellow-400','bg-slate-300','bg-amber-700'].map((c,i) => (
              <div key={i} className={`w-4 h-4 rounded-full ${c} opacity-80`} />
            ))}
          </div>
        </div>
        <div>
          <h3 style={{ fontFamily: 'Oswald, sans-serif' }} className="text-5xl uppercase leading-none">Gold<br/>Rush</h3>
          <p className="text-xs mt-2 tracking-wider text-yellow-200 font-semibold">AFRICA AT THE GAMES</p>
        </div>
      </div>
    ),
    article: {
      title: 'A Continent Stood Up',
      subtitle: 'At Paris 2024, Africa\'s 38 medals told a story about depth, diversity and a sporting powerhouse coming of age',
      author: 'Kofi Asante',
      role: 'Olympic Correspondent',
      readTime: '9 min read',
      pullQuote: 'Kenya topped the African medal table with 11 medals. Botswana won its first Olympic gold. Algeria produced a gymnast who made history. South Sudan made its Olympic debut and won. Paris 2024 was Africa\'s Games.',
      body: [
        'Twelve African nations qualified for the Paris 2024 Olympics, and the continent came home with 38 medals — thirteen gold, twelve silver and fourteen bronze. It was a performance that surpassed previous editions, reflecting a maturation of sports science, coaching infrastructure and athlete development across multiple disciplines and multiple countries. Africa is no longer a continent that produces distance runners and little else. It is a full-spectrum sporting power.',
        'Kenya led the African medal table with eleven medals including four golds, all in athletics. The Kenyan distance running tradition continued in its most dominant form: Beatrice Chebet won gold in both the women\'s 5,000 metres and 10,000 metres. Emmanuel Wanyonyi won the men\'s 800 metres gold at the age of just 20. Faith Kipyegon became the only three-time Olympic champion in the women\'s 1,500 metres — a feat of sustained excellence across three Olympic cycles that may never be repeated.',
        'But the story of Paris 2024 was not only Kenya\'s. Algeria\'s Kaylia Nemour became Africa\'s first ever gymnastics medallist, winning gold on the uneven bars with a score of 15.700. The achievement was historic not just for Algeria but for the entire continent — a demonstration that African athletes can compete and win in technically demanding disciplines that have long been dominated by European and East Asian nations.',
        'Botswana\'s Letsile Tebogo, 21, won the men\'s 200 metres in 19.46 seconds — an African record — defeating world champion Noah Lyles in one of the most dramatic sprint finals in Olympic history. It was Botswana\'s first ever Olympic gold medal. Egypt\'s Ahmed Elgendy won gold in the modern pentathlon with a world record score of 1,555 points, making him the first Egyptian and African athlete to win Olympic gold in that event. Algeria\'s Imane Khelif won gold in women\'s boxing, becoming the first female Olympic boxer to win gold for her country.',
        'In football, Morocco and Egypt contested an all-African bronze medal match — the first time in Olympic football history that two African teams met in a bronze final. Morocco won 6-0, claiming their first ever Olympic medal in the sport. South Sudan made their Olympic debut in basketball, winning their first ever game. Nigeria\'s women\'s basketball team, guided by coach Rena Wakama, reached the quarter-finals for the first time in history.',
        'These are not isolated achievements. They are evidence of a systematic improvement across African sport — in coaching, nutrition, sports science, psychological support and institutional investment. The continent that produces the world\'s greatest distance runners is rapidly producing world-class competitors across track and field, combat sports, gymnastics, swimming and team sports. Paris was not Africa\'s ceiling. It was a new floor.',
      ],
    },
  },
  {
    ...
    issue: 'Issue #54',
    label: 'Issue #54: Football Money',
    desc: 'Nigeria\'s football economy — clubs, brands & billions.',
    coverBg: 'bg-green-900',
    img: `${process.env.PUBLIC_URL}/cover_12_football_business.jpg`,
    imgClass: 'w-full h-full object-cover opacity-50 grayscale',
    CoverContent: () => (
      <div className="absolute inset-0 flex flex-col justify-center p-8 text-white">
        <div className="border-t-4 border-green-400 pt-4">
          <h3 style={{ fontFamily: 'Oswald, sans-serif' }} className="text-5xl uppercase leading-none tracking-tight">The Business<br/>of Football</h3>
        </div>
        <p className="text-xs mt-4 text-green-300 tracking-[0.2em] font-bold uppercase">Where Sport Meets Capital</p>
      </div>
    ),
    article: {
      title: 'The Game Behind the Game',
      subtitle: 'African football is generating billions — but the money trail reveals uncomfortable truths about who benefits',
      author: 'Jide Adeyemi',
      role: 'Sports Business Correspondent',
      readTime: '8 min read',
      pullQuote: 'African players generate extraordinary value for European clubs. The continent that produces them sees a fraction of those economics. Understanding why — and how to change it — is the defining sports business question of this generation.',
      body: [
        'African football is a paradox at scale. The continent produces some of the most talented players in the world — players who fill the rosters of Europe\'s elite clubs, win Ballon d\'Or awards and attract the largest transfer fees in history. Victor Osimhen\'s €75 million move to Paris Saint-Germain in 2024 set a record for an African player. Riyad Mahrez, Mohamed Salah, Sadio Mané and a generation of African talent have collectively generated hundreds of millions in transfer fees, wages and commercial value for European clubs. Yet the African clubs and academies that identified and developed these players receive a fraction of that value in return.',
        'The structural problem is systemic. African football clubs operate in economies with limited commercial infrastructure — restricted broadcasting rights revenue, lower corporate sponsorship capacity, stadium attendance constrained by infrastructure and security challenges. While a top Premier League club might earn £300 million or more annually from broadcast rights alone, the most commercially advanced African club competitions generate revenues that are orders of magnitude smaller.',
        'The NPFL — Nigeria\'s top football league — has been on a trajectory of reform and improvement, but the financial gap with elite European leagues remains vast. The league\'s most significant recent development has been increased government and corporate interest in professionalising the product, with several clubs gaining new ownership structures and investment intent. Enyimba, Rangers International, Kano Pillars and others carry decades of supporter heritage, but the commercial infrastructure to monetise that heritage is still being built.',
        'Morocco\'s football development offers one model. The Moroccan Football Federation has invested systematically in coaching education, youth development infrastructure and national team performance for two decades. The payoff was the 2022 World Cup semi-final run — the best performance by an African nation in World Cup history — which generated enormous national pride and significant commercial interest in Moroccan football at every level.',
        'The opportunity for African football business is real. A continent of over 1.4 billion people, with a median age of 19, represents an enormous young audience with intense football passion. Digital distribution platforms are removing the geographic barriers that previously constrained broadcast revenue. The African Union\'s sports development agenda, combined with growing private equity interest in football across the continent, points toward a decade of commercial acceleration.',
        'The question is whether that acceleration benefits African clubs and players directly, or whether it primarily makes African football more efficient at exporting talent for others to monetise. The answer will depend on policy decisions being made now: about player regulations, broadcast rights structures, stadium development and the governance of football at continental and national level. The game is worth billions. The architecture to keep those billions on the continent is still under construction.',
      ],
    },
  },
  ...
  // ── Lifestyle ─────────────────────────────────────────────
  {
    ...
    issue: 'Issue #57',
    label: 'Issue #57: City Life',
    desc: 'Work, grind and balance in Africa\'s megacity.',
    coverBg: 'bg-orange-950',
    img: `${process.env.PUBLIC_URL}/cover_15_lagos_hustle.jpg`,
    imgClass: 'w-full h-full object-cover mix-blend-overlay opacity-60',
    CoverContent: () => (
      <div className="absolute inset-0 flex flex-col justify-end p-6 text-white bg-gradient-to-t from-orange-950 via-orange-950/30 to-transparent">
        <p className="text-[9px] font-black tracking-[0.3em] uppercase text-orange-300 mb-2">City Series · Lagos</p>
        <h3 style={{ fontFamily: 'Playfair Display, serif' }} className="text-4xl italic leading-tight">The Lagos<br/>Hustle</h3>
        <p className="text-xs mt-2 font-semibold text-orange-200">Finding balance in a city that never stops</p>
      </div>
    ),
    article: {
      title: 'The City That Refuses to Sit Down',
      subtitle: 'Lagos is overwhelming, chaotic and exhausting — and it is also the most electrifying entrepreneurial environment on Earth',
      author: 'Temi Lawson',
      role: 'Lifestyle Editor',
      readTime: '7 min read',
      pullQuote: '"Lagos is the paradise of hustlers," they say. That is not metaphor. It is the city\'s operating system. And the people who decode it build extraordinary things.',
      body: [
        'There is a particular kind of energy in Lagos that visitors experience first as overwhelming and long-term residents have learned to metabolise as fuel. The city — home to between 17 and 21 million people depending on how you draw the boundaries, Africa\'s most populous urban area — operates at a frequency that is unlike anywhere else on the continent and perhaps anywhere in the world.',
        'It begins at 5 a.m., when the first generators start and the first danfos begin filling. Lagos contributes over 25 percent of Nigeria\'s GDP while hosting a fraction of its land area. The concentration of economic activity, the density of ambition, the proximity of opportunity and catastrophe — these are not separate features of the city. They are the same feature, experienced differently depending on what you bring to it.',
        'The young professionals who have chosen Lagos as their arena of ambition describe a relationship with the city that is simultaneously exhausting and exhilarating. Ada, 26, who works in fintech in Lekki, describes her daily commute as "a two-hour investment in perspective." The chaos, she says, has made her operationally sharp in ways that no classroom could have. Chinedu, who left banking in 2024 to launch a logistics startup, frames Lagos as the ultimate market test: "If your product works here — in the traffic, in the power cuts, with the customer who has seen everything — it will work anywhere."',
        'The geography of ambition in Lagos has its own topology. Yaba, dubbed the Silicon Valley of Nigeria, houses major tech companies and co-working spaces alongside universities, creating a density of young talent and startup energy that has become genuinely distinctive. Victoria Island and Ikoyi remain the addresses of financial and corporate Lagos. But increasingly, ambition is distributed — Surulere, Ikeja, Gbagada all have their own entrepreneurial communities, shaped by the specific industries and opportunities in each area.',
        'What Lagos offers, underneath the chaos, is a market of extraordinary diversity and size that rewards genuine problem-solving mercilessly and swiftly. There are business ideas that would not survive a week in any other city in Nigeria that thrive in Lagos because the scale and density create niches that support specialisation. There are also business ideas that would succeed anywhere else but fail in Lagos because the competition is too fast, the customer too sophisticated and the environment too unforgiving.',
        'The generation of Lagosians redefining the city are also redefining what success looks like. Stability in 2026 Nigeria is less about the corner office and more about flexibility, multiple income streams, digital skills and a quality of life that does not sacrifice health and relationships on the altar of ambition. The Lagos hustle is real. But the Lagosians who are winning it are learning to run at a pace they can sustain — and teaching the city, slowly, to accommodate the human beings who make it possible.',
      ],
    },
  },
  {
  ...
  // ── Business: Nigeria Unicorn Factory ────────────────────
  {
    ...
    sortOrder: 7,
    category: 'business',
    title: "Nigeria's Unicorn Factory",
    issue: 'Issue #62',
    label: 'Issue #62: Tech Billions',
    desc: 'How Nigeria became Africa\'s leading producer of billion-dollar startups.',
    coverBg: 'bg-emerald-950',
    img: `${process.env.PUBLIC_URL}/cover_20_unicorn.jpg`,
    imgClass: 'w-full h-full object-cover opacity-30',
    CoverContent: () => (
      <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
    ),
    article: {
      title: "Nigeria's Unicorn Factory: How Africa's Most Populous Nation Became Its Biggest Tech Bet",
      subtitle: "With Moniepoint's 2025 unicorn milestone, $343M in funding and 205 deals in a single year, Nigeria remains the continent's most electrifying — and most volatile — startup arena",
      author: 'Taiwo Bankole',
      role: 'Business & Tech Editor',
      readTime: '10 min read',
      pullQuote: 'Nigeria has produced more billion-dollar startups than any other country in Africa. Flutterwave, OPay, Interswitch, Moniepoint, Andela — that list did not happen by accident. It happened because 220 million people with a problem is the most powerful force in entrepreneurship.',
      body: [
        'Late 2024 and early 2025 brought a milestone the Nigerian tech ecosystem had been building toward for years: Moniepoint joined the continent\'s unicorn club, achieving a valuation above $1 billion and cementing Nigeria\'s position as Africa\'s most prolific producer of billion-dollar technology companies. The announcement barely made the front pages — which is itself a signal of how normalised the extraordinary has become in a startup scene that already produced Flutterwave, OPay, Interswitch and Andela.',

        "## Nigeria's Startup Landscape in 2026\n\nThe numbers tell a story of both strength and tension. Nigeria led the entire African continent in deal volume in 2025, closing 205 transactions — more than Kenya's 89 or South Africa's 72. That deal volume reflects genuine depth: over 250 fintech companies alone, alongside fast-growing platforms in logistics, health, agriculture and clean energy. Chowdeck hit one million customer orders per month across Nigeria and Ghana in November 2025 after raising a $9 million Series A. Spiro is targeting 2,000 battery swap stations for electric motorcycles nationwide. Moove, the mobility fintech providing vehicle financing to ride-hailing drivers, is expanding across West Africa.\n\nYet the picture is complicated. Nigeria's average deal size in 2025 was just $1.6 million — against Kenya's $6.9 million and South Africa's $9.2 million. There were no megadeals above $50 million. The naira stood at approximately ₦1,420 per dollar by early 2026, with inflation at 25 to 30 percent. These headwinds are real, and they are eroding the consumer purchasing power that gives Nigerian startups their scale advantage.",

        "## Why Nigeria Still Wins\n\nThe structural advantages are not disappearing. Nigeria's population now exceeds 220 million — the largest consumer market in Africa — and that scale means startups can reach millions of users without crossing a border. In fintech, where limited access to traditional banking has created enormous demand, Nigerian startups are not competing with banks. They are building financial infrastructure that banks never created.\n\nNigeria has consistently attracted more venture capital than any other African country over the past decade. Y Combinator, Sequoia Capital, Tiger Global, SoftBank and Accel have all backed Nigerian startups. The NESG projected 5.5 percent GDP growth for Nigeria in 2026, contingent on continued structural reform. If that holds, conditions for a new wave of startup scaling will be more favourable than at any point since 2021.\n\nFlutterwave remains the centrepiece of the ecosystem's global ambition — a cross-border payments engine processing billions in transactions across multiple continents, expanding into North Africa and embedded finance. Its existence proves what is possible from Lagos. It also sets the standard against which every subsequent Nigerian unicorn is measured.",

        "## The Profitability Pivot\n\nThe most significant shift in 2025 and 2026 is not in deal volume or valuation — it is in investor expectations. The growth-at-all-costs era is definitively over. Late 2024 saw a continent-wide pivot toward profitability, unit economics and demonstrable impact. Investors who previously backed top-line growth are now demanding paths to profit, evidence of customer retention, and clarity on how margins improve at scale.\n\nThis is actually good news for the ecosystem, even if it feels punitive in the short term. Startups that survive this filter — Moniepoint's profitability-first model is the clearest example — tend to build more durable, more defensible businesses. The froth of 2021 valuations has cleared. What remains is a cohort that has been pressure-tested by one of the harshest operating environments in the world and is still standing, still growing, still hiring.",

        "## What Comes Next\n\nThe next wave of Nigerian unicorns is unlikely to come from fintech alone. The ecosystem is diversifying. Clean energy startups are attracting increasing attention as the 2025 Green Mobility Bill creates regulatory tailwinds for electric vehicle infrastructure. Spiro's battery-swap model is already demonstrating that the economics of clean transport can work in Nigeria's conditions. Healthtech — solving the logistics problems that plague Nigerian hospitals — is gaining commercial traction. Agritech is approaching maturation.\n\nNigeria's entrepreneurial culture remains its most durable competitive advantage. The density of ambition in Lagos — where 25 percent of national GDP is generated in a single city — creates a concentration of talent, capital and market insight that no policy document can manufacture. The unicorn factory is not a government programme. It is a disposition: the belief, held by millions of young Nigerians, that the problem in front of them is the business they are about to build. That belief has already produced more billion-dollar companies than anywhere else in Africa. It is not finished.",
      ],
    },
  },
