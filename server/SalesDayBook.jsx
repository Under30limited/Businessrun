    ...
    <div id="sale-receipt-canvas" style={{
      ...
      <div style={{ background: '#18181b', padding: '40px 48px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            <div style={{ width: 40, height: 40, background: '#C5A028', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
              <span style={{ color: '#fff', fontWeight: 900, fontSize: 16, fontStyle: 'italic' }}>B</span>
            </div>
      ...
      {/* Totals */}
      <div style={{ padding: '20px 48px 40px', background: '#fafafa', borderTop: '1px solid #e4e4e7' }}>
        ...
        <div style={{ marginTop: 40, paddingTop: 24, borderTop: '1px solid #e4e4e7', display: 'flex', justifyContent: 'flex-end' }}>
          <div style={{ textAlign: 'right', minWidth: 180 }}>
            ...
            <p style={{ fontSize: 12, fontWeight: 700, margin: 0 }}>{receiptBusiness}</p>
